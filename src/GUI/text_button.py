...
class TextButton:
    def __init__(self, rect, start_transparency, hover_transparancy,
        ...
        self.text = src.GUI.Text(text, text_size, text_color, text_font, self.rect.x, self.rect.y)
        ...
        self.panel = src.GUI.Panel(self.rect, start_transparency, (0, 0, 0))
        self.hover_panel = src.GUI.Panel(self.rect, hover_transparancy, (0, 0, 0))
        self.function = None
